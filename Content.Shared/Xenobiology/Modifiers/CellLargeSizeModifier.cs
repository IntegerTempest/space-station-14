...
public sealed partial class CellLargeSizeModifier : CellModifier
{
    public override void OnAdd(Entity<CellContainerComponent> ent, Cell cell, IEntityManager entityManager)
    {
        ...
        foreach (var (fixtureId, fixture) in fixtures.Fixtures)
        {
            ...
            {
                physicsSys.SetRadius(ent, fixtureId, fixture, fixture.Shape, 0.45f);
                physicsSys.SetCollisionMask(ent, fixtureId, fixture, (int)CollisionGroup.LargeMobMask);
                physicsSys.SetCollisionLayer(ent, fixtureId, fixture, (int)CollisionGroup.LargeMobLayer);
            }
        }
    }
