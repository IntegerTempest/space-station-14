...
public sealed partial class CellMediumSizeModifier : CellModifier
{
    public override void OnAdd(Entity<CellContainerComponent> ent, Cell cell, IEntityManager entityManager)
    {
        ...
        foreach (var (fixtureId, fixture) in fixtures.Fixtures)
        {
            ...
            {
                physicsSys.SetRadius(ent, fixtureId, fixture, fixture.Shape, 0.35f);
                physicsSys.SetCollisionMask(ent, fixtureId, fixture, (int)CollisionGroup.MobMask);
                physicsSys.SetCollisionLayer(ent, fixtureId, fixture, (int)CollisionGroup.MobLayer);
            }
        }
    }
